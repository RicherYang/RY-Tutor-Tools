...
final class Option extends AbstractAdminPage
{
    ...
    {
        $menu_list[] = [
            'name' => __('Options', 'ry-tutor-tools'),
            'slug' => 'ry-options',
    ...
    {
        echo '<div class="wrap">';
        echo '<h1 class="wp-heading">' . esc_html__('Options', 'ry-tutor-tools') . '</h1>';

        echo '<form method="post" action="' . esc_url(admin_url('admin-post.php')) . '">';
        include __DIR__ . '/html/options.php';
        Utils::the_action_form_button('general-option', 'save-option', __('Save Changes', 'ry-tutor-tools'), 'submit', 'button-primary');
        echo '</form>';
    ...
    private function save_option(): void
    {
        ...
        $this->add_notice('success', __('Settings saved.', 'ry-tutor-tools'));
    }
}
