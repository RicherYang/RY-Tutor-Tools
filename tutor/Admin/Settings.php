...
final class Settings
{
    ...
    public function admin_scripts()
    {
        ...
        if ('tutor_settings' === $page) {
            ...
            wp_enqueue_script(\RY_TFTUTOR::OPTION_PREFIX . 'admin-main', RY_TFTUTOR_PLUGIN_URL . 'assets/admin/main.js', $asset_info['dependencies'], $asset_info['version'], true);
            wp_enqueue_style(\RY_TFTUTOR::OPTION_PREFIX . 'admin-main', RY_TFTUTOR_PLUGIN_URL . 'assets/admin/main.css', [], $asset_info['version']);
        }
    }
