...
final class Gateway
{
    public const LOG_HANDLE = 'smilepay-tutor-api';
    ...
    protected function do_init(): void
    {
        ...
        \RY_Logs::set_log(tutor_utils()->get_option('RY_smilepay_log', false), self::LOG_HANDLE);
    }

    public function add_method($methods)
    {
        $methods['ry_smilepay_credit'] = [
    ...
    public function add_method_setting($settings)
    {
        $settings[] = [
            ...
            'label' => _x('SmilePay Credit', 'gateway label', 'ry-tutor-tools'),
            'is_installed' => true,
            'is_active' => false,
            'icon' => RY_TFTUTOR_PLUGIN_URL . 'assets/icons/smilepay.png',
            ...
            'fields' => [
                [
                    ...
                    'value' => _x('SmilePay Credit', 'gateway label', 'ry-tutor-tools'),
                ],
            ],
        ];
    ...
    {
        $labels['ry_smilepay_credit'] = _x('SmilePay Credit', 'gateway label', 'ry-tutor-tools');
